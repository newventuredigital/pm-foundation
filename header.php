...
<header>
  <div class="row">
    <div class="columns">
      <!-- Logo Image Link -->
      <div class="logo"><a href="<?php bloginfo('url'); ?>"><img src="<?php // bloginfo('template_directory'); ?>http://placehold.it/260x80" alt=""></a></div>
      
      <!-- Basic Navigation Menu -->

      <!-- Menu with Background -->
      <?php wp_nav_menu(array('container' => false, 'theme_location' => 'main-nav-menu', 'items_wrap' => '<nav class="show-for-large-up background %2$s"><ul>%3$s</ul></nav>')); ?>
