...
<link rel="icon" type="image/png" href="<?php echo $base; ?>/favicon-194x194.png" sizes="194x194">
<link rel="icon" type="image/png" href="<?php echo $base; ?>/favicon-96x96.png" sizes="96x96">
<link rel="icon" type="image/png" href="<?php echo $base; ?>/android-chrome-192x192.png" sizes="192x192">
...
<meta name="msapplication-config" content="<?php echo $base; ?>/browserconfig.xml">
